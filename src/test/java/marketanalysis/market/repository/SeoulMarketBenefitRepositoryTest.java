...
@SpringBootTest
@Transactional
class SeoulMarketBenefitRepositoryTest {
    ...
    @Test
    void findAllByYearsAndQuarter() {
        //given
        Long year = 2021L;
        Long quarter = 4L;

        //when
        List<SeoulMarketBenefit> result = MARKET_BENEFIT_REPOSITORY.findAllByYearsAndQuarter(year, quarter);
    ...
    @Test
    void findAllByMarketTypeCd() {
        //given
        MarketTypeCd marketTypeCd = MarketTypeCd.A;

        //when
        List<SeoulMarketBenefit> result = MARKET_BENEFIT_REPOSITORY.findAllByMarketTypeCd(marketTypeCd);
    ...
    @Test
    void findAllByMarketCd() {
        //given
        Long marketCd = 2110001L;

        //when
        List<SeoulMarketBenefit> result = MARKET_BENEFIT_REPOSITORY.findAllByMarketCd(marketCd);
